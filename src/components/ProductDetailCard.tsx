...
interface ProductDetailCardProps {
  addTotheBasket: (number: number) => void;
}
...
const ProductDetailCard: React.FC<ProductDetailCardProps> = ({
 ...
 useEffect(() => {
  ...
  if (!product) return <p className="text-center font-bold text-2xl" >Produit non trouvé</p>;
  ...
  return (
    <motion.section
      ...
      className="relative"
    >
      <div className="w-full mx-auto px-4 sm:px-6 lg:px-0 bg-orange-100  rounded-md">
          ...
          <div className="img">
            <div className="img-box h-full max-lg:mx-auto  ">
              <img
                ...
                className="max-lg:mx-auto lg:ml-auto h-full object-cover rounded-md transition-transform duration-500 ease-in-out hover:scale-105"
              />
            </div>
          </div>
          <div className="data w-full lg:pr-8 pr-0 xl:justify-start justify-center flex items-center max-lg:pb-10 xl:my-2 lg:my-5 my-0">
            <div className="data w-full max-w-xl">
              <p className="text-lg font-medium leading-8 text-orange-600 mb-4">
                Clothing&nbsp; /&nbsp; Menswear
              </p>
              ...
              <div className="w-full pb-8 border-b border-gray-100 flex-wrap">
                <div className="grid grid-cols-3 min-[400px]:grid-cols-5 gap-3 max-w-md">
                  <button
                    className="bg-white text-center py-1.5 px-6 w-full font-semibold text-lg leading-8 text-gray-900 border border-gray-200 flex items-center rounded-full justify-center 
  ...
  hover:bg-gray-50 hover:shadow-sm hover:border-gray-300"
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 py-8">
                ...
                <button
                  ...
                  className="group py-4 px-5 rounded-full bg-orange-50 text-orange-600 font-semibold text-lg w-full flex items-center justify-center gap-2 
    transition-all duration-300 ease-in-out 
    hover:bg-orange-100 hover:shadow-md hover:scale-[1.02]"
                >
                  <svg
              ...
              <div className="flex items-center gap-3">
                <button className="group transition-all duration-500 p-4 rounded-full bg-orange-50 hover:bg-orange-100 hover:shadow-sm hover:shadow-orange-300">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="26"
                    height="26"
                ...
                <button
                  className="text-center w-full px-5 py-4 rounded-[100px] bg-orange-600 flex items-center justify-center font-semibold text-lg text-white shadow-sm 
  transition-all duration-300 ease-in-out 
  hover:bg-orange-700 hover:shadow-md hover:scale-[1.02]"
                >
                  Buy Now
                </button>
              </div>
